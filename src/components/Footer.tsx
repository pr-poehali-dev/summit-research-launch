          ...
          <div className="bg-neutral-950 py-4 sm:py-6 lg:py-8 px-4 sm:px-6 h-full w-full flex flex-col justify-between">
            <div className="flex shrink-0 gap-8 sm:gap-12 lg:gap-20">
              <div className="flex flex-col gap-1 sm:gap-2">
                <h3 className="mb-1 sm:mb-2 uppercase text-neutral-500 text-xs tracking-widest">Кейс</h3>
              ...
              <div className="flex flex-col gap-1 sm:gap-2 ml-auto text-right">
                <span className="text-neutral-500 text-xs tracking-widest uppercase mb-1">Цена</span>
                <span className="text-white text-2xl font-light tracking-tight">€4 200</span>
                <span className="text-neutral-500 text-xs">Лимитированная серия</span>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0">
              ...
              <p className="text-neutral-500 text-sm sm:text-base">{new Date().getFullYear()} · The Mandate</p>
            </div>
          </div>
        </div>
      </div>
